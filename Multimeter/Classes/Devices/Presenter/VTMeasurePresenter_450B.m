...
#import "VTMeasurePresenter_450B.h"
#import "VTLcdView.h"
#import "VTDialView.h"
...
@interface VTMeasurePresenter_450B()<VTSlotAlertViewDelegate>

@property (weak, nonatomic) UIView *contentView;
@property (strong, nonatomic) VTMeasureView_450B *view;
@property (strong, nonatomic) VTSlotAlertView *alertView;
@property (assign, nonatomic) NSInteger lastPointPos;

@end

@implementation VTMeasurePresenter_450B
...
- (UIView *)view {
    if (!_view) {
//        _view =  [[[NSBundle mainBundle] loadNibNamed:@"VTMeasureView_450B" owner:self options:nil]lastObject];
        _view = [VTMeasureView_450B new];
    }
    return _view;
}
