...
- (void)reloadNewData {
    ...
    if (!_scrollMode) {
        ...
        [plotSpace scaleToFitEntirePlots:theGraph.allPlots forCoordinate:CPTCoordinateY];
    }
    self.currentIndex++;
...
//{
//    if ([self.eventHandler respondsToSelector:@selector(touchUP)]) {
//        [self.eventHandler touchUP];
//    }
//    return NO;
//}
