...
+ (void)load {
    MJRefreshHeaderIdleText = VTLOCALIZEDSTRING(@"下拉可以刷新");
    MJRefreshHeaderPullingText = VTLOCALIZEDSTRING(@"松开立即刷新");
    MJRefreshHeaderRefreshingText = VTLOCALIZEDSTRING(@"正在刷新数据中...");
}
